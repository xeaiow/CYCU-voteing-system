...
<script>
    export default {
        ...
        mounted: function() {
            axios.get('//140.135.112.191/groups/info/' + this.$route.params.id).then(response => {this.items = response.data.groups;this.info = response.data.activity;this.message = response.data.message;})
